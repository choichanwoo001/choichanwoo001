...
> LLM · RAG · 자율주행 · 풀스택을 넘나드는 문제 해결형 개발자
...
### **🤖 PLS Jober**
**기업연계 파이널 프로젝트 · AI 알림톡 플랫폼**

> AI 기반 카카오 알림톡 템플릿 생성·수정·정책 검증 서비스

**Core:** RAG + LangChain 기반 템플릿 자동 생성 및 실시간 정책 검증
...
![Vue3](https://img.shields.io/badge/Vue%203-4FC08D?logo=vuedotjs&logoColor=white&style=flat-square)
...
**Highlights**
- RAG 기반 카카오 심사 정책 사전 검증 → 반려율 **60% → 85%** 개선
- LLM + 규칙 기반 하이브리드 처리로 응답시간 **10초 → 3~4초** 단축
- 대화형 채팅 기반 템플릿 수정 + 반려사유 인라인 하이라이팅 UI
- Spring Boot ↔ FastAPI WebClient 비동기 분리 아키텍처

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github)](https://github.com/choichanwoo001/jober-collaboration-project)

</td>
<td width="50%" valign="top">

### **📚 Sancheck**
**LLM × 자율주행 · Offline-to-Online 도서 탐색 플랫폼**

> AI 추천 에이전트와 SLAM 기반 자율주행 이동체를 결합한 스마트 서점 시스템

**Core:** LLM 추천 + 3D 실내 지도 + 제스처 결제

**Tech Stack:**
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square)
![React](https://img.shields.io/badge/React%2018-61DAFB?logo=react&logoColor=black&style=flat-square)
![Three.js](https://img.shields.io/badge/Three.js-000000?logo=threedotjs&logoColor=white&style=flat-square)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?logo=fastapi&logoColor=white&style=flat-square)
![OpenAI](https://img.shields.io/badge/OpenAI%20gpt--4o-412991?logo=openai&logoColor=white&style=flat-square)
![Supabase](https://img.shields.io/badge/Supabase-3ECF8E?logo=supabase&logoColor=white&style=flat-square)
![MediaPipe](https://img.shields.io/badge/MediaPipe-0097A7?style=flat-square)

**Highlights**
- Networkx 지식 그래프 + pgvector 임베딩 하이브리드 도서 추천
- 독서 비서 **Paige** – RAG 기반 도서 Q&A 및 서평 초안 자동 생성
- SLAM PGM 맵 → Three.js 3D 공간 자동 렌더링 (1인칭/3인칭/Overview)
- MediaPipe 온디바이스 제스처 모션 결제 & 실시간 도서 표지 인식

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github)](https://github.com/choichanwoo001/Sancheck)
...
### **🎵 Twiiiins**
**현대 음악 퍼포먼스 듀오 공식 웹사이트 · 풀스택 라이브 서비스**

> 비개발자 멤버도 운영 가능한 자체 CMS + CI/CD 자동화 아트 브랜딩 플랫폼

**Core:** 공연 아카이빙 + 어드민 CMS + 자동 배포
...
**Highlights**
- 공연·프로젝트 반응형 아카이브 (PC/Mobile 최적화 갤러리 & 메타데이터)
- Spring Security + JWT 기반 어드민 CMS (코드 없이 공연 등록/수정/삭제)
- WebP 압축 미디어 서빙 + 테크니컬 라이더 PDF 다운로드 파이프라인
- GitHub Actions → Docker ARM64 빌드 → GHCR → SSH 롤링 배포 자동화
- Let's Encrypt SSL 인증서 12시간 자동 갱신 (Certbot + Nginx)

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github)](https://github.com/choichanwoo001/Twiiiins)
...
![Vue3](https://img.shields.io/badge/Vue%203-4FC08D?logo=vuedotjs&logoColor=white&style=for-the-badge)
